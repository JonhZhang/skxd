                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar3.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar1.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar4.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar2.jpg"
                                         alt="...">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar6.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar7.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar8.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="${ctx}/resources/assets/admin/layout/img/avatar9.jpg"
                                         alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object"
                                         src="${ctx}/resources/assets/admin/layout/img/avatar10.jpg" alt="...">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object"
                                         src="${ctx}/resources/assets/admin/layout/img/avatar11.jpg" alt="...">
                                ...
                                <div class="page-quick-sidebar-chat-user-messages">
                                    <div class="post out">
                                        <img class="avatar" alt=""
                                             src="${ctx}/resources/assets/admin/layout/img/avatar3.jpg"/>
                                    ...
                                    <div class="post in">
                                        <img class="avatar" alt=""
                                             src="${ctx}/resources/assets/admin/layout/img/avatar2.jpg"/>
