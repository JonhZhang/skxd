                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            <input type="text"  id="startDate" onclick="laydate();" class="form-control"  placeholder="" style="width: 100px;height:30px;">
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                            <span class="input-group-addon green">结束时间</span>
                            <input type="text" id="endDate"  onclick="laydate();" class="form-control"  placeholder="" style="width: 100px;height:30px;">
                        </div>
                    </td>
